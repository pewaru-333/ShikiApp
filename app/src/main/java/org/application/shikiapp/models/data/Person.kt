...
data class Person(
    ...
    @Json(name = "person_favoured") val personFavoured: Boolean = false,
    @Json(name = "producer") val producer: Boolean = false,
    @Json(name = "producer_favoured") val producerFavoured: Boolean = false,
    @Json(name = "mangaka") val mangaka: Boolean = false,
    @Json(name = "mangaka_favoured") val mangakaFavoured: Boolean = false,
    @Json(name = "seyu") val seyu: Boolean = false,
    @Json(name = "seyu_favoured") val seyuFavoured: Boolean = false,
...
data class Roles(
    ...
    @Json(name = "animes") val animes: List<AnimeWork>
)

@JsonClass(generateAdapter = true)
data class Works(
    @Json(name = "anime") val anime: AnimeWork?,
